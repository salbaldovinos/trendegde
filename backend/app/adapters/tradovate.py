"""Tradovate adapter stub (Phase 2 implementation)."""
...
class TradovateAdapter(BrokerAdapter):
    """Tradovate adapter using REST/WebSocket API.
    ...
    async def connect(self) -> ConnectionStatus:
        raise NotImplementedError("Tradovate adapter: Phase 2 implementation")
